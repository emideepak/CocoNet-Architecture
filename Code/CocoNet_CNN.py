############################################################
# Program: CNN training and testing code for coconut tree 
#          identification
# Inputs: Training: 6 X 6 SAR image patches stored in
#                      'Dataset' folder 
...
# partition the data: 75% for training, 25% for testing
